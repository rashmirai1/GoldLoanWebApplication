...
public partial class GoldItemMaster : System.Web.UI.Page
{
    #region Declarations
    ...
    {
        Master.PropertyddlSearch.Items.Add("Item Name");
    ...
    protected void PropertybtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                GL_GoldItemMaster_PRV("Save", "0");
                GL_GoldItemMaster_PRI("Save", "0");
            ...
            {
                GL_GoldItemMaster_PRV("Update", hdnid.Value.Trim());
                GL_GoldItemMaster_PRI("Update", hdnid.Value.Trim());
                gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
            }
        }
        catch (Exception ex)
    ...
    protected void PropertybtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            GL_GoldItemMaster_PRV("Delete", hdnid.Value.Trim());
            GL_GoldItemMaster_PRI("Delete", hdnid.Value.Trim());
    ...
    protected void GL_GoldItemMaster_PRI(string Operation, string value)
    {
        ...
        cmd.CommandText = "GL_GoldItemMaster_PRI";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Operation", Operation);
        cmd.Parameters.AddWithValue("@ItemID", value);
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "GoldItemMaster", "alert('Record Saved Successfully');", true);
            ClearData();
            gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "GoldItemMaster", "alert('Record Update Successfully');", true);
            ClearData();
            gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "GoldItemMaster", "alert('Record Delete Successfully');", true);
            ClearData();
    ...
    protected void GL_GoldItemMaster_PRV(string Operation, string value)
    {
        conn = new SqlConnection(strConnString);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_GoldItemMaster_PRV";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Operation", Operation);
        cmd.Parameters.AddWithValue("@ItemID", value);
        cmd.Parameters.AddWithValue("@ItemName", txtItemName.Text.Trim());
    ...
    protected void GL_GoldItemMaster_PopUp()
    {
        conn = new SqlConnection(strConnString);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_GoldItemMaster_PopUp";
        cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void GL_GoldItemMaster_RTR(string id)
    {
        conn = new SqlConnection(strConnString);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_GoldItemMaster_RTR";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@ItemID", id);
        da = new SqlDataAdapter(cmd);
        dt = new DataTable();
        da.Fill(dt);
        hdnid.Value = dt.Rows[0]["ItemID"].ToString();
        txtItemName.Text = dt.Rows[0]["ItemName"].ToString();
        hdnoperation.Value = "Update";
        conn.Close();
    }

    protected void GL_GoldItemMaster_Search()
    {
        conn = new SqlConnection(strConnString);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_GoldItemMaster_Search";
        cmd.CommandType = CommandType.StoredProcedure;
