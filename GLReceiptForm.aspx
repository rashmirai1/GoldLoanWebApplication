<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="GLReceiptForm.aspx.cs" Inherits="GLReceiptForm" %> 
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            var ddlInterestCurrentNarration = document.getElementById("<%=ddlInterestCurrentNarration.ClientID %>");
            ...
            if (parseFloat(txtPrincipalCurrentAmt.value) > 0) {
                ...
                //if (ddlPrincipalCurrentAcHead.selectedIndex == 0) {
                    if (ddlPrincipalCurrentAcHead.value == "0") {
            ...
            if (parseFloat(txtInterestCurrentAmt.value) > 0) {
                ...
                if (ddlInterestCurrentAcHead.selectedIndex == -1)
                    //   if (hdnddlInterestCurrentAcHead.value == "0") 
                    //    if (ddlInterestCurrentAcHead.value == "0")    
                {
          ...
          //  alert(document.getElementById('ddlPenalCurrentAcHead'));
            if (parseFloat(txtPenalCurrentAmt.value) > 0) {
                ...
                //    return false;
                // }
                if (ddlPenalCurrentAcHead.selectedIndex == -1) {
                ...
                ddlPenalCurrentAcHead.selectedIndex == -1
                document.getElementById("<%=hdnddlPenalCurrentAcHead.ClientID %>").value = 0;
            ...
            if (parseFloat(txtChargesCurrentAmt.value) > 0) {
                ...
                if (ddlChargesCurrentAcHead.selectedIndex == -1) {
            ...
            if (parseFloat(txtAdvInterest.value) > 0) {
                ...
                if (ddlAdvIntAcHead.selectedIndex == -1) {
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="margin: 6px; width: 99%;"
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">Received Date
            </td>
            <td class="txt_style">
            ...
            <td rowspan="6" valign="top">
                <asp:Panel CssClass="RoundedPanel" ID="panOutstandingAmount" Style="width: 95%; border: 2px solid #354d8d; margin-top: 6px;"
                    runat="server">
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                        <tr>
                            <td class="label" colspan="2" style="text-align: center; font-weight: bold; background-color: #354d8d; color: #ffffff;">Outstanding Details
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label" style="background-color: #354d8d; color: #ffffff; text-align: left; padding-left: 5px;">
                                <strong>Total</strong>
                            </td>
                ...
                <div class="RoundedPanel label" style="width: 92%; background-color: #5a5952; color: #ffffff; margin-top: 5px; padding-top: 5px; padding-left: 5px; text-align: left;">
                    <asp:Label ID="lblBalanceLoanEligibility" runat="server" Text="Balance Loan Eligibility : "
                        Style="font-weight: bold;"></asp:Label>
                    <asp:Label ID="lblBalanceLoanEligibilityAmount" runat="server" Text="0" Style="font-weight: bold; float: right; padding-right: 5px;"></asp:Label>
                </div>
            </td>
            <td rowspan="6" valign="top">
                <asp:Panel CssClass="RoundedPanel" ID="panPLDetails" Style="width: 90%; border: 2px solid #354d8d; margin-top: 6px;"
                    runat="server">
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                        <tr>
                            <td class="label" colspan="2" style="text-align: center; font-weight: bold; background-color: #354d8d; color: #ffffff;">PL Details
                            </td>
                        </tr>
                        <tr>
                            <td class="label" style="text-align: left; padding-left: 5px; width: 70%;">
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">Gold Loan No.
            </td>
            <td class="txt_style">
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">Loan date
            </td>
            <td class="txt_style">
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">Scheme Name
            </td>
            <td class="txt_style">
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">ROI(%)
            </td>
            <td class="txt_style">
        ...
        <tr>
            <td class="label" style="text-align: left; width: 11%;">Loan Amount
            </td>
            <td class="txt_style">
    ...
    <div>
        <table cellpadding="0" cellspacing="0" border="1" style="margin: 6px; width: 98%;"
            ...
            <tr>
                <td>
                    <table cellpadding="1" id="pnlPrincipal" cellspacing="0" border="0" style="width: 100%; margin: 0px;"
                        runat="server">
                        <tr>
                            <td style="text-align: center; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 17%; font-family: Calibri; font-size: 14px; height: 25px; padding-top: 5px; padding-left: 2px;">Received Details
                            </td>
                            <td class="label" style="text-align: center; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 15%; font-family: Calibri; font-size: 14px; height: 25px; padding-top: 5px; padding-left: 2px;">Amount
                            </td>
                            <td class="label" style="text-align: center; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 30%; font-family: Calibri; font-size: 14px; height: 25px; padding-top: 5px; padding-left: 2px;">A/c Head
                            </td>
                            <td class="label" style="text-align: center; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 30%; font-family: Calibri; font-size: 14px; height: 25px; padding-top: 5px; padding-left: 2px;">Narration
                            </td>
                        </tr>
                        <tr>
                            <td class="label" style="text-align: left; width: 17%;">Principal - Current Loan
                            </td>
                            <td class="txt_style">
                            ...
                            <td class="txt_style">
                                ...
                                <asp:HiddenField ID="hdnddlPrincipalCurrentAcHead" runat="server" />
                            </td>
                            <td class="txt_style">
                    ...
                    <asp:Panel ID="pnlInterest" Style="width: 100%;" runat="server">
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%; margin: 0px;">
                            <tr>
                                ...
                                <td class="label" style="text-align: left;">From Date
                                ...
                                <td class="label" style="text-align: left;">To Date
                            ...
                            <tr>
                                ...
                                <td class="txt_style" style="width: 30%;">
                                    <asp:DropDownList ID="ddlInterestCurrentAcHead" class="textbox" Height="27px" Width="100%" OnSelectedIndexChanged="ddlInterestCurrentAcHead_SelectedIndexChanged"
                                        runat="server">
                                    </asp:DropDownList>
                                    <asp:HiddenField ID="hdnddlInterestCurrentAcHead" runat="server" />
                                </td>
                                <td class="txt_style" style="width: 30%;">
                                    <asp:DropDownList ID="ddlInterestCurrentNarration" class="textbox" Height="27px"
                                        Width="100%" runat="server">
                                    </asp:DropDownList>
                                    <%--<asp:HiddenField ID="hdnddlInterestCurrentNarration" runat="server" />--%>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlPenalInterest" Style="width: 100%;" runat="server">
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%; margin: 0px;">
                            <tr>
                                <td class="label" style="width: 17%; text-align: left;">Penal Interest - Current Loan
                                </td>
                                <td class="txt_style" style="width: 15%;">
                                ...
                                <td class="txt_style" style="width: 30%;">
                                    ...
                                    <asp:HiddenField ID="hdnddlPenalCurrentAcHead" runat="server" />
                                </td>
                                <td class="txt_style" style="width: 30%;">
            ...
            <tr>
                <td> 
                    <asp:Panel ID="pnlCharges" Style="width: 100%;" runat="server">
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%; margin: 0px;">
                            <tr>
                                <td class="label" style="width: 17%; text-align: left;">Charges - Current Loan
                                </td>
                                <td class="txt_style" style="width: 15%;">
                                ...
                                <td class="txt_style" style="width: 30%;">
                                    ...
                                    <asp:HiddenField runat="server" ID="hdnddlChargesCurrentAcHead" />
                                </td>
                                <td class="txt_style" style="width: 30%;">
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel2" Style="width: 100%;" runat="server">
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%; margin: 0px;">
                            <tr>
                                <td class="label" style="width: 17%; text-align: left;">Advance Interest - Current Loan
                                </td>
                                <td class="txt_style" style="width: 15%;">
                            ...
                            <tr>
                                ...
                                <td class="txt_style" style="width: 30%;">
                                    ...
                                    <asp:HiddenField ID="hdnddlAdvIntAcHead" runat="server" />
                                </td>
                                <td class="txt_style" style="width: 30%;">
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel1" Style="width: 100%;" runat="server">
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%; margin: 0px;">
                            <tr>
                                <td class="label" style="width: 17%;">Total
                                </td>
                                <td class="txt_style" style="width: 15%;">
                                    <asp:TextBox ID="txtRcvTotal" class="textbox_readonly textbox_GLreceipt" runat="server"
                                        onkeyup="return Fixdecimal(this);" MaxLength="10" Style="width: 100px; text-align: left;"></asp:TextBox>
                                </td>
                                <td class="label" style="width: 30%;">Payment Mode<b style="color: Red;">*</b>
                                </td>
                               <%-- <td class="txt_style" style="width: 30%;">
                ...
                <tr>
                    <td align="left" style="width: 100%;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tr>
                                <td style="width: 20%;">
                                    <div style="text-align: left; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 205px; font-family: Calibri; font-size: 14px; height: 20px; padding-top: 5px; padding-left: 2px;">
                                        Chq/DD/NEFT/Online Details
                                    </div>
                                </td>
                                <td class="label" style="width: 30%;">Select Bank Account <b style="color: Red;">*</b>
                                </td>
                    ...
                    <td align="center">
                        <div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="gvChequeDetails" />
                                    <asp:AsyncPostBackTrigger ControlID="ddlPaymentMode" EventName="SelectedIndexChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </div>
                ...
                <tr>
                    <td align="left" style="width: 100%;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tr>
                                <td style="width: 20%;">
                                    <div style="text-align: left; font-weight: bold; background-color: #5a5952; color: #ffffff; width: 205px; font-family: Calibri; font-size: 14px; height: 25px; padding-top: 5px; padding-left: 2px;">
                                        Denomination Details
                                    </div>
                                </td>
                                <td class="label" style="width: 30%;">Select Cash Account<b style="color: Red;">*</b>
                                </td>
                                <td class="txt_style" style="width: 50%;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
            ...
            <tr>
                <td class="label" style="width: 20%; text-align: left;">Receipt Book No.
                    <td class="txt_style" style="width: 15%;">
                        <%--  <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>--%>
                        <%--     <asp:DropDownList ID="ddlReceiptBook" class="textbox" Height="27px" Width="99%" runat="server"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlReceiptBook_SelectedIndexChanged">
                            </asp:DropDownList>--%>
                    ...
                    <td class="label" style="width: 20%; text-align: left; padding-left: 20px;">Received From <b style="color: Red;">*</b>
                    </td>
            ...
            <tr>
                <td class="label" style="text-align: left;">Receipt No.
                </td>
                <td class="txt_style">
                    <%-- <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>--%>
                    <%--  <asp:DropDownList ID="ddlReceipt" class="textbox" Height="27px" Width="99%" runat="server">
                            </asp:DropDownList>--%>
                    <asp:TextBox ID="txtReceipt" runat="server" class="textbox" MaxLength="4"></asp:TextBox>
                    <%-- </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="ddlReceiptBook" EventName="SelectedIndexChanged" />
                        </Triggers>
                    </asp:UpdatePanel>--%>
                </td>
                <td class="label" style="text-align: left; padding-left: 20px;">Collected By <b style="color: Red;">*</b>
                </td>
                <td class="txt_style">
            ...
            <tr>
                <td class="label"></td>
                <td class="txt_style"></td>
                <td class="label" style="text-align: left; padding-left: 20px;">Cashier's Name
                </td>
                <td class="txt_style">
    ...
    <%--    <script>
        ...
        $("#MainContent_ddlInterestCurrentAcHead").click(function (e) {

            $.ajax({
                type: "POST",
                url: "WebMethod.aspx/GetAccount",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    ...
                    var drpcount = ($("#MainContent_ddlInterestCurrentAcHead").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlInterestCurrentAcHead").empty();
                        $("#MainContent_ddlInterestCurrentAcHead").append("<option value='0'>--Select A/c Head--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlInterestCurrentAcHead").append("<option value='" + key.AccountId + "'>" + val.Name + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlPenalCurrentAcHead").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlPenalCurrentAcHead").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlPenalCurrentAcHead").empty();
                        $("#MainContent_ddlPenalCurrentAcHead").append("<option value='0'>--Select A/c Head--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlPenalCurrentAcHead").append("<option value='" + key.AccountId + "'>" + val.Name + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlChargesCurrentAcHead").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlChargesCurrentAcHead").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlChargesCurrentAcHead").empty();
                        $("#MainContent_ddlChargesCurrentAcHead").append("<option value='0'>--Select A/c Head--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlChargesCurrentAcHead").append("<option value='" + key.AccountId + "'>" + val.Name + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlAdvIntAcHead").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlAdvIntAcHead").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlAdvIntAcHead").empty();
                        $("#MainContent_ddlAdvIntAcHead").append("<option value='0'>--Select A/c Head--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlAdvIntAcHead").append("<option value='" + key.AccountId + "'>" + val.Name + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlPrincipalCurrentNarration").click(function (e) {

            $.ajax({
                type: "POST",
                url: "WebMethod.aspx/GetNarration",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlPrincipalCurrentNarration").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlPrincipalCurrentNarration").empty();
                        $("#MainContent_ddlPrincipalCurrentNarration").append("<option value='0'>--Select Narration--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlPrincipalCurrentNarration").append("<option value='" + key.NarrationId + "'>" + val.NarrationName + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlInterestCurrentNarration").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlInterestCurrentNarration").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlInterestCurrentNarration").empty();
                        $("#MainContent_ddlInterestCurrentNarration").append("<option value='0'>--Select Narration--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlInterestCurrentNarration").append("<option value='" + key.NarrationId + "'>" + val.NarrationName + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlPenalCurrentNarration").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlPenalCurrentNarration").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlPenalCurrentNarration").empty();
                        $("#MainContent_ddlPenalCurrentNarration").append("<option value='0'>--Select Narration--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlPenalCurrentNarration").append("<option value='" + key.NarrationId + "'>" + val.NarrationName + "</option>");
                        });
                    }
        ...
        $("#MainContent_ddlChargesCurrentNarration").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data.d.length);
                    var datacount = data.d.length
                    var drpcount = ($("#MainContent_ddlChargesCurrentNarration").children('option').length) - 1;
                    if (drpcount != datacount) {
                        $("#MainContent_ddlChargesCurrentNarration").empty();
                        $("#MainContent_ddlChargesCurrentNarration").append("<option value='0'>--Select Narration--</option>")
                        $.each(data.d, function (key, val) {
                            $("#MainContent_ddlChargesCurrentNarration").append("<option value='" + key.NarrationId + "'>" + val.NarrationName + "</option>");
                        });
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="afterJqueryContentPlaceHolder" runat="Server">
    <script type="text/javascript">

        $(document).ready(function ($) {
            //ddlPrincipalCurrentAcHead
            SetAcHead($('#<%=ddlPrincipalCurrentAcHead.ClientID%>'));
            if ($('#<%=hdnddlPrincipalCurrentAcHead.ClientID%>').val().length > 0) {
                var ddl = $('#<%=ddlPrincipalCurrentAcHead.ClientID%>');
                var hdn = $('#<%=hdnddlPrincipalCurrentAcHead.ClientID%>');
                GetAcHead(ddl, hdn.val());
            }
            $('#<%=ddlPrincipalCurrentAcHead.ClientID%>').change(function (evt) {
                var id = $(this).val();
                var hdn = $('#<%=hdnddlPrincipalCurrentAcHead.ClientID%>');
                hdn.val(id);
            });

            //ddlInterestCurrentAcHead
            SetAcHead($('#<%=ddlInterestCurrentAcHead.ClientID%>'));
                if ($('#<%=hdnddlInterestCurrentAcHead.ClientID%>').val().length > 0) {
                    var ddl = $('#<%=ddlInterestCurrentAcHead.ClientID%>');
                    var hdn = $('#<%=hdnddlInterestCurrentAcHead.ClientID%>');
                    debugger
                    GetAcHead(ddl, hdn.val());
                }
                $('#<%=ddlInterestCurrentAcHead.ClientID%>').change(function (evt) {
                    var id = $(this).val();
                   var hdn = $('#<%=hdnddlInterestCurrentAcHead.ClientID%>');
                        hdn.val(id);
            ...
            //ddlPenalCurrentAcHead
            SetAcHead($('#<%=ddlPenalCurrentAcHead.ClientID%>'));
            if ($('#<%=hdnddlPenalCurrentAcHead.ClientID%>').val().length > 0) {
                var ddl = $('#<%=ddlPenalCurrentAcHead.ClientID%>');
                var hdn = $('#<%=hdnddlPenalCurrentAcHead.ClientID%>');
                GetAcHead(ddl, hdn.val());
            }
            $('#<%=ddlPenalCurrentAcHead.ClientID%>').change(function (evt) {
                
                var id = 0;
                if (($('#<%=txtPenalCurrentAmt.ClientID%>').val()) > 0) {
                    id = $(this).val();
                    var hdn = $('#<%=hdnddlPenalCurrentAcHead.ClientID%>');
                    hdn.val(id);
                } else {
            ...
            //ddlChargesCurrentAcHead
            SetAcHead($('#<%=ddlChargesCurrentAcHead.ClientID%>'));
            if ($('#<%=hdnddlChargesCurrentAcHead.ClientID%>').val().length > 0) {
                var ddl = $('#<%=ddlChargesCurrentAcHead.ClientID%>');
                var hdn = $('#<%=hdnddlChargesCurrentAcHead.ClientID%>');
                GetAcHead(ddl, hdn.val());
            }
            $('#<%=ddlChargesCurrentAcHead.ClientID%>').change(function (evt) {

               
                var id = 0;
                if (($('#<%=txtChargesCurrentAmt.ClientID%>').val()) > 0) {
                    id = $(this).val();
                    var hdn = $('#<%=hdnddlChargesCurrentAcHead.ClientID%>');
                    hdn.val(id);
                }else{
            ...
            //ddlAdvIntAcHead
            SetAcHead($('#<%=ddlAdvIntAcHead.ClientID%>'));
            if ($('#<%=hdnddlAdvIntAcHead.ClientID%>').val().length > 0) {
                var ddl = $('#<%=ddlAdvIntAcHead.ClientID%>');
                var hdn = $('#<%=hdnddlAdvIntAcHead.ClientID%>');
                GetAcHead(ddl, hdn.val());
            }
            $('#<%=ddlAdvIntAcHead.ClientID%>').change(function (evt) {
                var id = $(this).val();
                var hdn = $('#<%=hdnddlAdvIntAcHead.ClientID%>');
                hdn.val(id);
            });

            function SetAcHead(ddl) {
                ...
                ddl.select2({
                    ajax: {
                        ...
                        dataType: "json",
                        type: "POST",
                        url: 'WebService.asmx/GetListofAccounts',
                        params: {
                            contentType: 'application/json; charset=utf-8'
                        },
            ...
            function GetAcHead(ddl, hdnValue) {

                $.ajax({
                    type: "POST",
                    url: 'WebService.asmx/GetAccount',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ "AccountID": hdnValue }),
                    success: function (data) {
                        var d = data.d;
                        ddl.append($('<option selected></option>').val(d[0].id).html(d[0].text));
                        ddl.trigger('change');
                    },
...
<%--            //$('#<%=ddlPrincipalCurrentAcHead.ClientID%>').append($('<option selected></option>').val(4).html("--aa--"));
            //SetAcHead($('#<%=ddlPrincipalCurrentNarration.ClientID%>'));
            //GetAcHead($('#<%=ddlPrincipalCurrentAcHead.ClientID%>'), 0);
            //if ($('#<%=hdnddlPrincipalCurrentAcHead.ClientID%>').val().length > 0) {
            //    var ddl = $('#<%=ddlPrincipalCurrentAcHead.ClientID%>');
            //    var hdn = $('#<%=hdnddlPrincipalCurrentAcHead.ClientID%>');
            //    SetAcHead(ddl);
            ...
            //            success: function (data) {
            //                var d = data.d;
            //                ddl.append($('<option selected></option>').val(0).html("--Select A/c Head--"));
            //                $.each(d, function (key, val) {
            //                    ddl.append($('<option selected></option>').val(val.id).html(val.text));
            //                });
            //                ddl.trigger('change');
            //            },
            //            error: function (xmlHttpRequest, textStatus, errorThrown) {
