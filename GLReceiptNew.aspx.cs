...
public partial class GLReceiptNew : System.Web.UI.Page
{
    #region [Declarations]
    ...
    public void BindPlCases_Details(string plno)
    {
        ...
        cmd = new SqlCommand();
        cmd.Connection = connAIM;
        cmd.CommandText = "select isnull((select distinct case isnull(F.LoginID,0) when 0 then S.LoanAmount else 0 end LoanAmount " +
                            ...
                            "where ReceivedFrom=(SELECT top 1 AccountID FROM tblAccountMaster A " +
                            ...
                            "where ReceivedFrom=(SELECT top 1 AccountID FROM tblAccountMaster A with (NOLOCK) " +
                            "inner join TDisbursement_Appl_BasicInfo B with (NOLOCK) on A.Alies=B.LoginID AND A.GPID='67' " +
                            "WHERE B.CaseNo='" + plno + "') " +
    ...
    public void GLReceipt_PRI(string operation, string value)
    {
        ...
        cmd.Parameters.AddWithValue("@RecCLPNarID", ddlPrincipalCurrentNarration.SelectedValue);
        ...
        cmd.Parameters.AddWithValue("@RecCLIAccID", ddlInterestCurrentAcHead.SelectedValue);
        cmd.Parameters.AddWithValue("@RecCLINarID", ddlInterestCurrentNarration.SelectedValue);
        ...
        cmd.Parameters.AddWithValue("@RecCLPIAccID", ddlPenalCurrentAcHead.SelectedValue);
        cmd.Parameters.AddWithValue("@RecCLPINarID", ddlPenalCurrentNarration.SelectedValue);
        ...
        cmd.Parameters.AddWithValue("@RecCLCAccID", ddlChargesCurrentAcHead.SelectedValue);
        cmd.Parameters.AddWithValue("@RecCLCNarID", ddlChargesCurrentNarration.SelectedValue);
        if (txtRcvTotal.Text != "")
        {
        ...
        if (txtAdvInterest.Text != "" && Convert.ToDouble(txtAdvInterest.Text) > 0)
        {
            ...
            cmd.Parameters.AddWithValue("@AdvInterestAccID", ddlAdvIntAcHead.SelectedValue);
        }
        else
        {
    ...
    public void ClearData()
    {
        ...
        ddlPrincipalCurrentAcHead.SelectedIndex = 0;
        ...
        ddlAdvIntAcHead.SelectedIndex = 0; ddlAdvIntNarration.SelectedIndex = 0;
    }
    ...
    protected void PropertybtnCancel_Click(object sender, EventArgs e)
    {
        try
        {
            //string selectedValue = Request.Form[ddlInterestCurrentAcHead.UniqueID];
           
            //string s = ddlInterestCurrentAcHead.SelectedValue;
    ...
    [WebMethod]   
    public static int insertreceipt()
    {
        int result = 0;
       // string s = req.Form["MainContent_ddlInterestCurrentAcHead"];
        string ss = HttpContext.Current.Request.Form["MainContent_ddlInterestCurrentAcHead"];
    ...
    public static IList<Account> GetAccount()
    {
        ...
        var list = dt.AsEnumerable().Select(dataRow => new Account
        {
            ...
            AccountName = dataRow.Field<string>("Name"),
