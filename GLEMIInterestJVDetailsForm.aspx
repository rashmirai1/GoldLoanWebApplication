<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="GLEMIInterestJVDetailsForm.aspx.cs" Inherits="GLEMIInterestJVDetailsForm"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table align="center" cellpadding="0" cellspacing="0" border="0" style="width: 95%;">
        ...
        <tr>
            ...
            <td >
                <!-- Regex validation for Gold Loan No -->
                <asp:RequiredFieldValidator ID="ReqRefNum" runat="server" ErrorMessage="Select Ref-No." ControlToValidate="ddlRefNum"
                    ValidationGroup="save" ForeColor="Red" Display="Dynamic"  Font-Size="Small"
                    SetFocusOnError="True" InitialValue="0"></asp:RequiredFieldValidator>
                <asp:RequiredFieldValidator ID="ReqRefID" runat="server" ErrorMessage="Select Ref-ID." ControlToValidate="ddlRefID"
                    ValidationGroup="save" ForeColor="Red" Display="Dynamic"  Font-Size="Small"
                    SetFocusOnError="True" InitialValue="0"></asp:RequiredFieldValidator>
            </td>
            <td>
        ...
        <tr>
            <!-- JV ReferenceNo -->
            <td align="right">
                <asp:Label ID="Label1" runat="server" Text="JV Reference No" CssClass="label" ForeColor="Red"></asp:Label>
            </td>
            <td class="txt_style" valign="middle">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtJVreferenceNo" CssClass="textbox_readonly" runat="server" Width="90%"
        ...
        <tr>
            ...
            <td colspan="5">
                ...
                <asp:CustomValidator runat="server" ID="CustomValidator1" ControlToValidate="ddlPaymentType"
                    ClientIDMode="Static" ForeColor="Red" Display="Dynamic" Font-Size="Small" SetFocusOnError="True"
        ...
        <%--<tr>
            ...
            <td>
                <!-- Custom Validator for Payment Type -->
                <asp:CustomValidator runat="server" ID="CustomValidator5" ControlToValidate="ddlPenalChargesAccount"
                    ClientIDMode="Static" ForeColor="Red" Display="Dynamic" Font-Size="Small" SetFocusOnError="True"
                    OnServerValidate="ddlPenalChargesAccount_ServerValidate" ErrorMessage="Select Penal A/C."
                    ValidationGroup="save" />
            </td>
        </tr>--%>
        <tr>
            ...
            <td class="txt_style">
                <asp:UpdatePanel ID="UpdatePanel22" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <!-- Custom Validator -->
                        <asp:CustomValidator runat="server" ID="CustomValidator5" ControlToValidate="ddlProcessingChargesAccount"
                            ClientIDMode="Static" ForeColor="Red" Display="Dynamic" Font-Size="Small" SetFocusOnError="True"
        ...
        <tr>
            ...
            <!-- Monthly Payment -->
            <td align="right">
                <asp:Label ID="Label2" runat="server" Text="Monthly Payment" CssClass="label" ForeColor="Red"
        ...
        <tr>
            <!--Save Button -->
            <td align="center" colspan="6" style="height: 51px">
                <br />
                <br />
