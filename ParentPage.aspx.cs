...
public partial class ParentPage : System.Web.UI.Page
{
    ...
    #region[PropertygvGlobal_PreRender]
    ...
    #endregion [PropertygvGlobal_PreRender]
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
               ...
               // ClientScript.RegisterStartupScript(this.GetType(), "Pop Up", "window.open('GLOutstanding.aspx');", true);
            }
    ...
    #region[PropertygvGlobal_RowCommand]
    protected void gvGlobal_RowDataBound(object sender, GridViewCommandEventArgs e)
    {
        try
        {
