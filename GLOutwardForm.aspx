<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="GLOutwardForm.aspx.cs" Inherits="GLOutwardForm" Theme="GridViewTheme"
    EnableViewStateMac="false" MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <table align="left" cellpadding="0" cellspacing="0" border="0" style="width: 95%;">
        <tr>
            <td style="width: 20%;">
            </td>
            <td style="width: 30%;">
                ...
                <table align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                    ...
                    <tr>
                        <td align="center" colspan="4" class="header">
                            <asp:Label ID="lblHeader" runat="server" Text="GOLD LOAN Outward Form"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
        ...
        <tr>
            ...
            <td class="txt_style">
                <asp:TextBox ID="txtRefNo" CssClass="textbox_readonly" runat="server" Font-Bold="true"
            ...
            <td class="txt_style" colspan="3">
                <asp:TextBox ID="txtGlcaseNo" CssClass="textbox_readonly" runat="server" Font-Bold="true"
                    Width="90%"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="txt_style">
                <asp:TextBox ID="txtloanDate" CssClass="textbox_readonly" runat="server" Font-Bold="true"
                    Width="90%"></asp:TextBox>
            </td>
            <td class="label">
                Name:
            ...
            <td class="txt_style">
                <asp:TextBox ID="txtName" CssClass="textbox_readonly" runat="server" Font-Bold="true"
                    Width="90%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:MultiView ID="mvOnselectionInwarttype" runat="server" ActiveViewIndex="0">
                    <asp:View ID="vGold" runat="server">
                        <asp:GridView ID="gvGoldDetails" runat="server" AutoGenerateColumns="false" PageSize="20">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Item Desc" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                    <FooterStyle HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField HeaderText="Inward Ref. No." HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left"></asp:TemplateField>
                                <asp:TemplateField HeaderText="Stock Location" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left"></asp:TemplateField>
                                <asp:TemplateField HeaderText="Outward To" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Outward To Location" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left"></asp:TemplateField>
                            </Columns>
                    ...
                    <asp:View ID="vDoc" runat="server">
                        <asp:GridView ID="gvDocumentDetails" runat="server" AutoGenerateColumns="false" PageSize="20">
                            <Columns>
        ...
        <tr>
            ...
            <td class="txt_style">
                <asp:TextBox ID="txtinwardby" CssClass="textbox_readonly" runat="server" Font-Bold="true"
                    Width="90%"></asp:TextBox>
            </td>
            <td class="label">
                Date And Time:
            ...
            <td class="txt_style">
                <asp:TextBox ID="txtDatetime" CssClass="textbox_readonly" runat="server" Font-Bold="true"
                    Width="90%"></asp:TextBox>
            </td>
        </tr>
    </table>
