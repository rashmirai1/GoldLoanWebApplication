...
public partial class CityMaster : System.Web.UI.Page
{
    ...
    protected void Bindstate()
    {
        ...
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_StateBound_RTR";
    ...
    {
        Master.PropertyddlSearch.Items.Add("City Name");
        Master.PropertyddlSearch.Items.Add("State Name");
        Master.PropertyddlSearch.Items.Add("STD Code");
    }
    ...
    protected void PropertybtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                GL_CityMaster_PRV("Save", "0");
                GL_CityMaster_PRI("Save", "0");
                gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
            }
            if (hdnoperation.Value == "Update")
            {
                GL_CityMaster_PRV("Update", hdnid.Value.Trim());
                GL_CityMaster_PRI("Update", hdnid.Value.Trim());
                gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
            }
        }
        catch (Exception ex)
    ...
    protected void PropertybtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            GL_CityMaster_PRV("Delete", hdnid.Value.Trim());
            GL_CityMaster_PRI("Delete", hdnid.Value.Trim());
    ...
    protected void GL_CityMaster_PRI(string Operation, string value)
    {
        conn = new SqlConnection(strConnStringAIM);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_CityMaster_PRI";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Operation", Operation);
        cmd.Parameters.AddWithValue("@CityID", value);
        cmd.Parameters.AddWithValue("@CityName", txtCity.Text.Trim());
        cmd.Parameters.AddWithValue("@StateID", ddlState.SelectedValue);
        cmd.Parameters.AddWithValue("@CityStdCode", txtStdCode.Text.Trim());
        cmd.Parameters.AddWithValue("@CityBlackListed", 'N');
        cmd.Parameters.AddWithValue("@Lineno", 0);
        result = cmd.ExecuteNonQuery();
        conn.Close();
        if (Operation == "Save" && result > 0)
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "CityeMaster", "alert('Record Saved Successfully');", true);
            ClearData();
            gbl.CheckAEDControlSettings("Save", Master.PropertybtnEdit, Master.PropertybtnSave, Master.PropertybtnDelete, Master.PropertybtnView, Master.PropertybtnCancel);
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "CityMaster", "alert('Record Update Successfully');", true);
                ClearData();
                ...
                {
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "CityMaster", "alert('Record Delete Successfully');", true);
                    ClearData();
    ...
    protected void GL_CityMaster_PRV(string Operation, string value)
    {
        conn = new SqlConnection(strConnStringAIM);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_CityMaster_PRV";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Operation", Operation);
        cmd.Parameters.AddWithValue("@CityID", value);
        cmd.Parameters.AddWithValue("@CityName", txtCity.Text.Trim());
    ...
    protected void GL_CityMaster_PopUp_RTR()
    {
        conn = new SqlConnection(strConnStringAIM);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_CityMaster_PopUp_RTR";
        cmd.CommandType = CommandType.StoredProcedure;
        da = new SqlDataAdapter(cmd);
        dt = new DataTable();
        da.Fill(dt);
    ...
    protected void GL_CityMaster_RTR(string id)
    {
        conn = new SqlConnection(strConnStringAIM);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_CityMaster_RTR";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@CityID", id);
        da = new SqlDataAdapter(cmd);
        dt1 = new DataTable();
        da.Fill(dt1);
        hdnid.Value = dt1.Rows[0]["CityID"].ToString();
        txtCity.Text = dt1.Rows[0]["CityName"].ToString();
        ddlState.SelectedValue = dt1.Rows[0]["StateID"].ToString();
        Bindstate();
        txtStdCode.Text = dt1.Rows[0]["CityStdCode"].ToString();
        hdnoperation.Value = "Update";
        conn.Close();
    }

    protected void GL_CityMaster_Search()
    {
        conn = new SqlConnection(strConnStringAIM);
        conn.Open();
        cmd = new SqlCommand();
        cmd.Connection = conn;
        cmd.CommandText = "GL_CityMaster_Search";
        cmd.CommandType = CommandType.StoredProcedure;
